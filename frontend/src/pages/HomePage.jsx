...
import { useStore, CATEGORIES } from "../lib/store.jsx";
...
export default function HomePage() {
  ...
  useSeo({
    description: "Fully handmade wooden art from Egypt — painted panels, mosaic mirrors, and occasion decor inspired by Pharaonic and Oriental heritage. Handmade in Egypt, 100% authentic, free shipping.",
  });
  ...
  return (
    <>
      ...
      <section id="top" style={{ position: "relative", height: "min(88vh, 680px)", overflow: "hidden" }}>
        <SkeletonImg
          src="/images/products/tray-hero.jpg"
      ...
      <section style={{ maxWidth: 720, margin: "90px auto 0", padding: "0 20px 30px", textAlign: "center" }}>
        <Reveal>
          ...
          <h2 className="serif" style={{ fontSize: 30, fontWeight: 600, marginBottom: 20, letterSpacing: 0.5 }}>Handmade with Heart</h2>
          <p style={{ color: MUTED, lineHeight: 2, fontSize: 15 }}>
            Zakhrafa started with a simple passion for wood and color, and grew into a small
            workshop turning raw material into art. Every piece is shaped by brush and chisel
            — no printing, no mass production — inspired by Egypt's layered Pharaonic and
            Oriental heritage.
          </p>
